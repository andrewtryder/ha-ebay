...
SUMMARY_SENSORS = [
    ...
    EbaySummarySensorDescription(
        key="held_funds",
        translation_key="held_funds",
        value_key="held_funds",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    ...
    EbaySummarySensorDescription(
        key="last_payout_date",
        translation_key="last_payout_date",
        value_key="last_payout_date",
        feature=CONF_FINANCES_ENABLED,
        device_class=SensorDeviceClass.TIMESTAMP,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        ...
        translation_key="failed_payout_count",
        value_key="failed_payout_count",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="returned_payout_count",
        translation_key="returned_payout_count",
        value_key="returned_payout_count",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="last_failed_payout_date",
        translation_key="last_failed_payout_date",
        value_key="last_failed_payout_date",
        feature=CONF_FINANCES_ENABLED,
        device_class=SensorDeviceClass.TIMESTAMP,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="recent_fees",
        translation_key="recent_fees",
        value_key="recent_fees",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="recent_refunds",
        translation_key="recent_refunds",
        value_key="recent_refunds",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="recent_net",
        translation_key="recent_net",
        value_key="recent_net",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="daily_fees",
        translation_key="daily_fees",
        value_key="daily_fees",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="daily_refunds",
        translation_key="daily_refunds",
        value_key="daily_refunds",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    ...
    EbaySummarySensorDescription(
        key="daily_payout_total",
        translation_key="daily_payout_total",
        value_key="daily_payout_total",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="monthly_fees",
        translation_key="monthly_fees",
        value_key="monthly_fees",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="monthly_refunds",
        translation_key="monthly_refunds",
        value_key="monthly_refunds",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="monthly_net",
        translation_key="monthly_net",
        value_key="monthly_net",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
    EbaySummarySensorDescription(
        key="monthly_payout_total",
        translation_key="monthly_payout_total",
        value_key="monthly_payout_total",
        feature=CONF_FINANCES_ENABLED,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ),
...
class EbaySummarySensor(CoordinatorEntity[EbayDataUpdateCoordinator], SensorEntity):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        if self.entity_description.key in {
            ...
            currency = summary.get("funds_currency")
            if currency is not None:
                attrs["currency"] = currency
